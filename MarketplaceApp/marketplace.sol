...
contract Marketplace {
    ...
    event ItemListed (uint256 indexed itemld, address indexed seller, string name, uint256 price);
    event ItemPurchased(uint256 indexed itemld, address indexed buyer, address indexed seller, uint256 price);
    ...
    function buyItem(uint256 _itemId) external payable {
        ...
        item.isSold = true; item.seller.transfer(msg.value);
